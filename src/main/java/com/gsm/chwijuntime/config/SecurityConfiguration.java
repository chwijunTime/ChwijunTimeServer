...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/*/login", "/*/join","/exception/**", "/*/member/**", "/*/email-check", "/*/check/findPw", "/*/check/findPw/sendEmail", "/*/auth/refresh", "/robots.txt").permitAll() // 가입 및 인증 주소, 오류, 이메일 인증은 누구나 접근가능
